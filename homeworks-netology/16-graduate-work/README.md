...
Использовались конфигурационные файлы из папки [Zero part](Zero part/infrastructure) для создания сервисного аккаунта и бакета для удаленного хранения конфигурации. 
